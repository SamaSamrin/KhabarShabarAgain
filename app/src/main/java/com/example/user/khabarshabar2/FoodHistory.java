 ...
 * {@link FoodHistory.OnFragmentInteractionListener} interface
...
public class FoodHistory extends Fragment {
    ...
    private static final String TAG = "***FoodHistory***";
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof MyAccount.OnFragmentInteractionListener) {
            Log.e(TAG, "context is an instance of OnFragmentInteractionListener");
            mListener = (FoodHistory.OnFragmentInteractionListener) context;
